...
class AppTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineMedium: GoogleFonts.babylonica(fontSize: 24.0, fontWeight: FontWeight.w600, color: Colors.black),
    ...
    bodyMedium: GoogleFonts.encodeSans(fontSize: 14.0, fontWeight: FontWeight.normal, color: Colors.black),
